  ...
  my = {
    ...
    wayland.windowManager.sway = {
      ...
      config = {
        ...
        keybindings =
          let
            mod = config.my.wayland.windowManager.sway.config.modifier;
            left = config.my.wayland.windowManager.sway.config.left;
            right = config.my.wayland.windowManager.sway.config.right;
            up = config.my.wayland.windowManager.sway.config.up;
            down = config.my.wayland.windowManager.sway.config.down;
          in
          {
